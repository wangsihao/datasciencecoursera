...
reifnest::ReifModule reifmodule_LTX_mod;

// -- DynModule functions ------------------------------------------------------

reifnest::ReifModule::ReifModule()
  {
#ifdef LINKED_MODULE
...
reifnest::ReifModule::~ReifModule()
   ...
   const std::string reifnest::ReifModule::name(void) const
   {
     return std::string("My NEST Module"); // Return name of the module
   }

   const std::string reifnest::ReifModule::commandstring(void) const
   {
     // Instruct the interpreter to load mymodule-init.sli
     return std::string("(reifmodule-init) run");
   }
   ...
   /* BeginDocumentation
      ...
      Connect
   */
   void reifnest::ReifModule::StepPatternConnect_Vi_i_Vi_i_lFunction::execute(SLIInterpreter *i) const
   {
  ...
  void reifnest::ReifModule::init(SLIInterpreter *i, nest::Network*)
  {
    ...
    */
    ...
    nest::register_model<reif_cond_alpha_RK5>(nest::NestModule::get_network(),
                                        "reif_cond_alpha_RK5");
