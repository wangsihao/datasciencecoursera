...
public:
   ...
   */
  DropOddSpikeConnection(): ConnectionBase()
  {}
  ...
  void check_connection(nest::Node & s, nest::Node & t,
		  	            nest::rport receptor_type, nest::double_t, const CommonPropertiesType &)
   {
   ...
   */
  void send(nest::Event& e, nest::thread t, nest::double_t t_lastspike,
...
template <typename targetidentifierT>
inline
void DropOddSpikeConnection<targetidentifierT>::send(nest::Event& e, nest::thread t,
													 nest::double_t last,
...
template<typename targetidentifierT>
void DropOddSpikeConnection<targetidentifierT>::get_status(DictionaryDatum & d) const
{
...
template<typename targetidentifierT>
void DropOddSpikeConnection<targetidentifierT>::set_status(const DictionaryDatum & d, nest::ConnectorModel& cm)
{
