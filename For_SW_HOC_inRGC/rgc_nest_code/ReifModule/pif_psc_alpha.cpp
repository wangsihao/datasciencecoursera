...
nest::RecordablesMap<reifnest::pif_psc_alpha> reifnest::pif_psc_alpha::recordablesMap_;
...
namespace nest
{
  ...
  template <>
  void RecordablesMap<reifnest::pif_psc_alpha>::create()
  {
    // use standard names whereever you can for consistency!
    insert_(names::V_m, &reifnest::pif_psc_alpha::get_V_m_);
  }
}
...
reifnest::pif_psc_alpha::Parameters_::Parameters_()
  : C_m    (250.0),  // pF
    I_e    (  0.0),  // nA
    tau_syn(  2.0),  // ms
    V_th   (-55.0),  // mV
...
reifnest::pif_psc_alpha::State_::State_(const Parameters_& p)
  : V_m       (p.V_reset),
    dI_syn    (0.0),
    I_syn     (0.0),
    I_ext     (0.0),
...
void reifnest::pif_psc_alpha::Parameters_::get(DictionaryDatum &d) const
{
  (*d)[names::C_m    ] = C_m;
  (*d)[names::I_e    ] = I_e;
...
void reifnest::pif_psc_alpha::Parameters_::set(const DictionaryDatum& d)
{
...
void reifnest::pif_psc_alpha::State_::get(DictionaryDatum &d) const
{
...
void reifnest::pif_psc_alpha::State_::set(const DictionaryDatum& d, const Parameters_& p)
{
...
reifnest::pif_psc_alpha::Buffers_::Buffers_(pif_psc_alpha &n)
  : logger_(n)
{}

reifnest::pif_psc_alpha::Buffers_::Buffers_(const Buffers_ &, pif_psc_alpha &n)
  : logger_(n)
{}
...
reifnest::pif_psc_alpha::pif_psc_alpha()
  : Archiving_Node(),
    P_(),
    S_(P_),
    B_(*this)
...
reifnest::pif_psc_alpha::pif_psc_alpha(const pif_psc_alpha& n)
  : Archiving_Node(n),
    P_(n.P_),
    S_(n.S_),
    B_(n.B_, *this)
...
void reifnest::pif_psc_alpha::init_state_(const Node& proto)
{
  const pif_psc_alpha& pr = downcast<pif_psc_alpha>(proto);
  S_ = pr.S_;
}

void reifnest::pif_psc_alpha::init_buffers_()
{
...
void reifnest::pif_psc_alpha::calibrate()
{
  B_.logger_.init();
...
void reifnest::pif_psc_alpha::update(Time const& slice_origin,
...
void reifnest::pif_psc_alpha::handle(SpikeEvent & e)
{
...
void reifnest::pif_psc_alpha::handle(CurrentEvent& e)
{
  assert(e.get_delay() > 0);
...
void reifnest::pif_psc_alpha::handle(DataLoggingRequest& e)
{
