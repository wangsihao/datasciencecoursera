function [prob_d,varargout] = run_IaF_Badel_Recur_Rect(StimParam)
% Old arguments
...
total_time = 1*10^5; %ms; 10^4 appropriate for testing, 10^5 for real sim 
dt = StimParam.dt;   %ms


%Matlab implementaion of Badel et al fit            
[Spikes, counter_bins, StimParam] = simulate_spikes_Badel_Recur_Rect(total_time,dt,StimParam);
